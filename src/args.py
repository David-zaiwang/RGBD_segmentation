...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        self.add_argument('--results_dir',
                          default='/data/zaiwang/workspace_2021/ESANet/results')
        ...
        self.add_argument('--finetune',
                          default='/data/zaiwang/workspace_2021/ESANet/pretrain_model/nyuv2_r34_NBt1D_scenenet/nyuv2/r34_NBt1D_scenenet.pth',
                          type=str,
        ...
        self.add_argument('--dataset_dir',
                          default='/data/zaiwang/Dataset/NYUDepthv2',
